...
export async function getControlOperativo():Promise<ControlOperativoRow[]>{
  ...
  return rows.map((r:any)=>({
    ...
    contacto_cliente:text(r.contacto_cliente??r.telefono_cliente),
...
export async function cambiarEstadoOperativo(args:{id_reserva:number;estado:EstadoOperativo;motivo?:string|null}):Promise<unknown>;
export async function cambiarEstadoOperativo(idReserva:number,estado:EstadoOperativo,motivo?:string|null):Promise<unknown>;
export async function cambiarEstadoOperativo(arg1:{id_reserva:number;estado:EstadoOperativo;motivo?:string|null}|number,arg2?:EstadoOperativo,arg3?:string|null){
  const args=typeof arg1==="number"?{id_reserva:arg1,estado:arg2 as EstadoOperativo,motivo:arg3}:{...arg1};
